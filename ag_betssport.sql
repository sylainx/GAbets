...
--
-- Host: localhost:8889
-- Generation Time: Jan 06, 2023 at 04:04 PM
...
(41, 28, 25, 1, '2023-01-05 00:00:00', '2023-01-05 00:00:00', NULL, 1, 'PORTUGAL'),
(42, 24, 18, 1, '2023-01-05 00:00:00', '2023-01-05 00:00:00', NULL, 1, 'ESPAGNE'),
(43, 20, 29, 1, '2023-01-05 00:00:00', '2023-01-05 00:00:00', NULL, 1, 'HAITI'),
(44, 26, 27, 1, '2023-01-05 00:00:00', '2023-01-05 00:00:00', NULL, 1, 'ESPAGNE'),
(45, 31, 30, 1, '2023-01-05 00:00:00', '2023-01-05 00:00:00', NULL, 1, 'ESPAGNE');
...
CREATE TABLE `test2` (
  `id` int(33) NOT NULL,
  `title` int(22) NOT NULL,
  `rrrr` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
